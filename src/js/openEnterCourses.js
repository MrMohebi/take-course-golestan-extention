...
async function openEnterCourses(courseCodes){
    try {
        ...
        for (let i = 0; i < MAX_TRIES; i++) {
            ...
            console.log("xxxxxx")
            if (document.getElementById(iframeId).contentWindow[5].document.getElementById('errtxt')?.title === "عمليات با موفقيت انجام شد."){
                break
            }
        }
